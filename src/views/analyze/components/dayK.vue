...
const fetDayKCodes = analyzeMetaStores.requestDayKCodes;
const { dayKCodes } = storeToRefs(analyzeMetaStores);
...
<template>
    ...
    <v-chart style="height: 400px;" :loading="dayKLoading" :autoresize="true" :option="kLineOptions"></v-chart>
</template>
